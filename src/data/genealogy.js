...
export const members = [
  ...
  { id: 'jiejin', name: '捷金', courtesy: '漢才', generation: 24, branch: 'left-3',
    birth: '1937-05-12',
    deeds: '1959年負笈雲南求學，畢生盡瘁滇省水電建設與醫療衛生事業。遍歷六郎洞、綠水河、開遠諸地，襄建以禮河、羅平大寨、魯布格電站。退休後定居曲靖。',
    spouses: [{ name: '蔡欽木', surname: '蔡', birth: '1942-08-05', note: '四川籍',
...
export const migrations = [
  ...
  { year: '解放初期', from: '興寧', to: '廣州', person: '捷登', event: '赴穗求學謀生，娶妻生子，扎根羊城', landmark: 'guangzhou',
    yearEn: 'Early 1950s', fromEn: 'Xingning', toEn: 'Guangzhou', eventEn: 'Went to Guangzhou to study and work, married and settled in the city' },
  { year: '1959', from: '興寧', to: '雲南曲靖', person: '捷金（漢才）', event: '早年負笈滇東，辭粵土而遠遊。學成心繫邊疆，就地安身立業。', landmark: 'qujing',
    yearEn: '1959', fromEn: 'Xingning', toEn: 'Qujing, Yunnan', eventEn: 'Left Guangdong to study in eastern Yunnan. After graduating, devoted himself to the frontier and settled there.' },
