...
export const members = [
  ...
  { id: 'jiedeng', name: '捷登', generation: 24, branch: 'left-3',
    ...
    spouses: [{ name: '陳秉慈', surname: '陳', birth: '1932-01-12', death: '2012-04-02',
      children: ['qiuling_d','meiling_d','qiaoling_d','xinsong','xintao','congling_d','qiumei_d'] }] },
  ...
  { id: 'qiuling_d', name: '秋玲', generation: 25, branch: 'left-3',
    birth: '1963-08-27', note: '女，捷登長女',
    spouses: [{ name: '尹梁', surname: '尹' }] },
  { id: 'meiling_d', name: '梅玲', generation: 25, branch: 'left-3',
    birth: '1964-08-15', note: '女，捷登次女',
    spouses: [{ name: '何子強', surname: '何' }] },
  { id: 'qiaoling_d', name: '巧玲', generation: 25, branch: 'left-3',
    birth: '1966-10-09', note: '女，捷登三女',
  ...
  { id: 'congling_d', name: '聰玲', generation: 25, branch: 'left-3',
    birth: '1976-10-22', note: '女，捷登六女',
    spouses: [{ name: '鍾曉東', surname: '鍾' }] },
  { id: 'qiumei_d', name: '秋玫', generation: 25, branch: 'left-3',
    birth: '1976-10-31', note: '女，捷登七女',
